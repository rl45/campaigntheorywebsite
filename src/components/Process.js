            ...
            <div className="row margin-t-50">
                <div className="col-lg-4 plan-line">
                    <div className="text-center process-box">
                        ...
                        <h4 className="padding-t-15">Choose Campaign Package</h4>
                        <p className="text-muted">Select either package: Economy, Deluxe, Ultimate</p>
                    </div>
                </div>
                <div className="col-lg-4 plan-line">
                    <div className="text-center process-box">
                        <i className="pe-7s-id text-custom"></i>
                        <h4 className="padding-t-15">Recieve Questionnaire</h4>
                        <p className="text-muted">Includes details that will help us create your target audience and branding</p>
                    </div>
                </div>
                <div className="col-lg-4">
                    <div className="text-center process-box">
                        <i className="pe-7s-target text-custom"></i>
                        <h4 className="padding-t-15">Launch Campaign</h4>
                        <p className="text-muted">We then continue to optimize your campaigns regularly</p>
                    </div>
                </div>
                <div className="text-center mx-auto">
                <a href="#pricing" className="btn btn-custom waves-light waves-effect margin-t-50">Get Started <i className="mdi mdi-arrow-right"></i></a>
                </div>
            </div>
        </div>
    </section>
